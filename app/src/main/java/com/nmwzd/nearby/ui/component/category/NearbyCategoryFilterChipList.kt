package com.nmwzd.nearby.ui.component.category
...
import com.nmwzd.nearby.data.model.mock.mockCategories


/*
* Created by Nuno Melo on 12/14/2024.
* Email : nuno.melo@nmwzd.com
* Copyright (c) 2024 NMWZD. All rights reserved.
*/
@Composable
fun NearbyCategoryFilterChipList(modifier: Modifier = Modifier, categories: List<Category>, onSelectCategoryChanged: (Category) -> Unit) {
    ...
    LaunchedEffect(key1 = selectedCategoryId) {
        ...
        selectedCategoryOrNull?.let { onSelectCategoryChanged(it) }
